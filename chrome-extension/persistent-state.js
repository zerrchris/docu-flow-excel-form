...
(function() {
  ...
  if (window.runsheetProPersistentStateLoaded) {
    console.log('🔧 RunsheetPro Extension: Persistent state already loaded, skipping');
    return;
  }
  window.runsheetProPersistentStateLoaded = true;
