          ...
          <div className="py-4">
            <RunsheetFileUpload 
              onFileSelected={async (runsheetData) => {
                console.log('📥 Runsheet file processed (unified service):', runsheetData);
                
                // Use unified service for upload
                const success = await RunsheetService.uploadRunsheet(runsheetData, navigate);
