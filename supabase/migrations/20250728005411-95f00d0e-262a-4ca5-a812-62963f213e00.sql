-- Remove Document File Name from default columns since document linker is used instead
UPDATE user_extraction_preferences 
SET columns = ARRAY['Inst Number', 'Book/Page', 'Inst Type', 'Recording Date', 'Document Date', 'Grantor', 'Grantee', 'Legal Description', 'Notes'],
    column_instructions = jsonb_build_object(
