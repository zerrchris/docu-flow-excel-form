...
-- Update the basic filename generation function with proper search_path
...
-- Update the preferences-based filename generation function with proper search_path
